...
struct indexamajig_arguments
{
    ...
    struct fast_feedback_options **fast_feedback_opts_ptr;
...
static error_t parse_arg(int key, char *arg, struct argp_state *state)
{
	...
	switch ( key ) {
        ...
        state->child_inputs[6] = args->fast_feedback_opts_ptr;
		break;
...
int main(int argc, char *argv[])
{
    ...
    struct fast_feedback_options *fast_feedback_opts = NULL;
    ...
    args.fast_feedback_opts_ptr = &fast_feedback_opts;
